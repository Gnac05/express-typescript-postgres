...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/Dahkenangnon/express-typescript-postgres#quick-start) section in README.md)
